...
BASE_URL = "https://ms.caltech.edu/people"
LIST_URL = "https://ms.caltech.edu/people/faculty"
OUTPUT_FILE = "caltech_ms_faculty.xlsx"
...
def get_area(driver):
    ...
    for block in blocks:
        title = get_text(block, "h4.person-page2__profile-block__title")
        if title.strip().lower() != "research overview":
            continue
...
def crawl_detail(driver, url):
    ...
    role = get_text(driver, "div.person-page2__field.field__job_title h6")
    if not role:
