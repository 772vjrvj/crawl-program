...
class GlobalState:
    ...
    SETTING_DETAIL_ALL_STYLE_FLAG: ClassVar[str] = "setting_detail_all_style_flag"
    ...
    SETTING_REGION_FILTER_FAVORITE_FLAG: ClassVar[str] = "setting_region_filter_favorite_flag"
    ...
    def initialize(self) -> None:
        if not self._initialized:
            self._data = {
                ...
                self.SETTING:[],
                self.SETTING_DETAIL: [],
                self.SETTING_DETAIL_ALL_STYLE: [],
                self.SETTING_DETAIL_ALL_STYLE_FLAG: False,
                self.SETTING_REGION_FILTER_FAVORITE: [],
                self.SETTING_REGION_FILTER_FAVORITE_FLAG: False,
                self.COLUMNS: [],
                self.REGION: [],
                self.POPUP: False,
                self.SITES: [],
